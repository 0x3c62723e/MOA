...
set "nceline=echo: &echo [-] This Tool Developed for my personal use only [-] &echo:"
set "eline=echo: &call :_color %Red% "[-] This Tool Developed for my personal use only [-]" &echo:"
...
set "nceline=echo: &echo [-] This Tool Developed for my personal use only [-]&echo:"
set "eline=echo: &call :dk_color %Red% "[-] This Tool Developed for my personal use only [-]" &echo:"
if %~z0 GEQ 200000 (
...
if not "%~1"=="Task" (
echo.
echo [-] This Tool Developed for my personal use only [-]
echo.
